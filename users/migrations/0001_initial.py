    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('user', 'Usuário Comum'), ('admin', 'Administrador'), ('superadmin', 'Super Administrador')], default='user', max_length=20, verbose_name='Tipo de Usuário')),
                ...
                ('is_deleted', models.BooleanField(default=False, help_text='Indica se o usuário foi deletado (soft delete)', verbose_name='Deletado')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dark_theme', models.BooleanField(default=False, verbose_name='Tema escuro')),
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Criado em')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='Atualizado em')),
